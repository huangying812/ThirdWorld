...
public class Hero extends BaseRole {
    ...
    public static Hero parse(String nickName, String renWuKeHuDuanJiChuShuxing, String chongWuKeHuDuanJiChuShuxing, String shuxingmingxiPet, String shuxingmingxiQianNeng, String shuxingmingxiShenQi, String shuxingmingxiShenShou, String shuxingmingxiXingHun, String shuxingmingxiTuiBian, String shuxingmingxiWuGong, String shuxingmingxiZhuangBei) {
        ...
        BaseRole pet = new BaseRole(petInfos[0], WuXing.parse(petInfos[1]), (int) (str2Int(petInfos[2]) * per.petHp), 0, (int) (str2Int(petInfos[3]) * per.petAttack), (int) (str2Int(petInfos[4]) * per.petDefense), (int) (str2Int(petInfos[5]) * per.petAgility));
        Hero hero = new Hero(nickName, pet, (int) (str2Int(heroInfos[0]) * per.heroHp), 0, (int) (str2Int(heroInfos[2]) * per.heroAttack), (int) (str2Int(heroInfos[3]) * per.heroDefense), (int) (str2Int(heroInfos[4]) * per.heroAgility));
        return hero;
    }
