...
import static szz.com.baselib.singleton.ConnectManager.AutoType.buyPetPice;
...
public class ConnectManager {
    ...
    /**
     * 盟军神兽副本挑战开始〓hy814〓123〓神兽副本1-1	183.60.204.16	183.60.204.16
     ...
     * <p>
     * 盟军神兽副本挑战开始〓hy814〓123〓神兽副本1-2	183.60.204.16	183.60.204.16
...
//                                  购买状态    | -------------元神+1到+9----------------|  宝箱  火淬 赞助点  固定     元宝     购买物品
    ...
    /**
     *  赞助2014获取〓hy814〓123	183.60.204.16	183.60.204.16
     ...
     *  赞助系统读取房产信息〓hy814〓123	183.60.204.16	183.60.204.16
     *  赞助系统读取房产信息返回〓1000007 56 37
     *  赞助系统读取房屋NPC〓hy814〓123〓1000007	183.60.204.16	183.60.204.16
     ...
     *  赞助系统房屋查询存宠明细〓hy814〓123〓1000007〓1000041	183.60.204.16	183.60.204.16
     *  赞助查询房屋存宠NPC明细〓绿衣仙子 122964，绿衣仙子 122960，绿衣仙子 122962，绿衣仙子 122965，绿衣仙子 122966，绿衣仙子 122961，绿衣仙子 122963，
     *  赞助系统房屋新增绿衣仙子〓hy814〓123〓1000007〓1000041〓1	183.60.204.16	183.60.204.16
     *  赞助查询房屋存宠NPC明细〓绿衣仙子 123379，绿衣仙子 122964，绿衣仙子 122960，绿衣仙子 122962，绿衣仙子 122965，绿衣仙子 122966，绿衣仙子 122961，绿衣仙子 122963，〓2197
     *
     *  摆摊使用特殊〓hy811〓123〓100018203	183.60.204.16	183.60.204.16
     *  摆摊使用特殊〓hy811〓123〓100018208	183.60.204.16	183.60.204.16
     *  摆摊使用特殊〓hy811〓123〓100018209	183.60.204.16	183.60.204.16
     *  摆摊使用特殊〓hy811〓123〓100018210	183.60.204.16	183.60.204.16
     *  摆摊使用特殊〓hy811〓123〓100018211	183.60.204.16	183.60.204.16
     *  摆摊使用特殊〓hy811〓123〓100018212	183.60.204.16	183.60.204.16
     *  摆摊使用特殊〓hy811〓123〓100018213	183.60.204.16	183.60.204.16
     *  成功！阁下使用 [※红利金丹] 提取到了红利 [36]
     *
     *  摆摊刷新携带〓hy811〓123	183.60.204.16	183.60.204.16
    ...
    private boolean processResponse(String res, String[] split, String cmd) {
        ...
        switch (split[0]) {
            ...
            case "盟军每日任务领奖完成":
                if (split.length >= 5) {
                    //盟军个人每日活力任务领取〓hy814〓123〓9	183.60.204.16	183.60.204.16
            ...
            case "帮派副本基本任务挑战结束":
                if (split.length >= 4) {
                    //盟军基本任务挑战开始〓hy815〓123〓303	183.60.204.16	183.60.204.16
            ...
            case "盟军黑店精髓商城读取成功":
                if (split.length >= 2) {
                    //盟军黑店精髓商城读取成功〓11310 碎片_盟宠_浴露鸠 300，11333 碎片_盟宠_雷鸣 300，11304 碎片_盟宠_啮风犬 300，11506 碎片_盟宠_紫衣 500，11319 碎片_盟宠_绿甲 300，11332 碎片_盟宠_小猪芬特 300，11325 碎片_盟宠_暴蓝龙 300，11302 碎片_盟宠_电球宝宝 300，11414 碎片_盟宠_小霹雳 400，11514 碎片_盟宠_菠萝蜜 500，11521 碎片_盟宠_幻云兽 500，11438 碎片_盟宠_青龙使 400〓000000000100〓0
                    String[] content = split[1].split("，");
                    String state = split[2];
                    for (int i = 0; i < content.length; i++) {
                        if (state.charAt(i) != '1' && (content[i].contains("晶天使") || content[i].contains("赤龙") || content[i].contains("金蝎龙") || content[i].contains("蓝鸟龙") || content[i].contains("幻晶刚"))) {
                            buyPetPice(i + 1,content[i]);
                            return false;
                        }
                    }
                    resetPetPiceShop();
            ...
            case "盟军黑店盟宠精髓购买完成":
                if (split.length >= 2) {
                    //盟军黑店盟宠精髓购买完成〓000000000100〓32986〓碎片_盟宠_菠萝蜜〓11514
                    readPetPiceShop();
                }
                break;
            case "":
            ...
            case "盟军物品使用提取活力":
                if (split.length >= 2) {
                    //帮派个人使用物品〓hy814〓123〓42941〓89	183.60.204.16	183.60.204.16
                    //盟军物品使用提取活力〓42941〓※增加活力〓0〓8226〓89
                    postMsg(String.format("提取活力成功，物品id%1$s，增加 %2$s 活力，当前活力 %3$s",split[1],split[5],split[4]));
                }
                break;
            case "盟军物品使用通用":
                if (split.length >= 2) {
                    //帮派个人使用物品〓hy812〓123〓43035〓10	183.60.204.16	183.60.204.16
                    //盟军物品使用通用〓43035〓※增加赞助点〓10
                    postMsg(String.format("使用 %1$s x %3$s 成功（物品id%2$s）",split[2],split[1],split[3]));
                }
                break;
            case "盟军物品使用盟宠经验水":
                if (split.length >= 2) {
                    //盟军物品使用盟宠经验水〓42698〓※盟宠经验水_少许〓31692〓2386
                    //帮派个人使用物品〓hy814〓123〓42697〓15	183.60.204.16	183.60.204.16
                    //盟军物品使用盟宠经验水〓42697〓※盟宠经验水_大量〓52479〓20787
            ...
            case "帮派读取私人物品":
                if (split.length >= 2) {
                    //帮派个人物品读取〓hy814〓123	183.60.204.16	183.60.204.16
                    //帮派读取私人物品〓神器_盘古斧+9 12 34752，※增加活力 89 42941，神兽丹_一星 23 1342，神兽丹_二星 4 37603，神兽丹_三星 1 37604，蜕变_三界灵丹_金 5 119，蜕变_三界灵丹_木 11 637，蜕变_三界灵丹_水 5 1217，蜕变_三界灵丹_火 11 1954，蜕变_三界灵丹_土 9 20836，蜕变_天琊灵珠[金] 0 3599，蜕变_碧魂灵珠[木] 0 4369，蜕变_玄清灵珠[水] 0 5241，蜕变_耀阳灵珠[火] 0 6142，蜕变_蝉翼灵珠[土] 0 6936，星魂_白羊 2 39727，星魂_金牛 10 26956，星魂_双子 12 26306，星魂_巨蟹 17 21215，星魂_狮子 2 34748，星魂_处女 4 27990，星魂_天秤 4 30227，星魂_天蝎 6 26307，星魂_射手 1 31415，星魂_山羊 5 31414，星魂_水瓶 2 36733，星魂_双鱼 1 36732，碎片_星魂_白羊 21 37703，碎片_星魂_金牛 346 21307，碎片_星魂_双子 273 22368，碎片_星魂_巨蟹 232 21212，碎片_星魂_狮子 98 21217，碎片_星魂_处女 86 21440，碎片_星魂_天秤 61 21210，碎片_星魂_天蝎 55 21778，碎片_星魂_射手 6 21211，碎片_星魂_水瓶 9 30269，碎片_星魂_双鱼 3 21309，通用星魂Ⅰ 3 42704，通用星魂Ⅱ 1 42705，青铜勋章 134 12869，白银勋章 113 13169，黄金勋章 11 21220，通用材料箱 304 42696，材料_冰蚕丝 5060 4326，材料_玄火晶 6127 6027，材料_不尽木 288 6028，材料_紫金鳞 276 6029，材料_天罡玉 274 6026，装备_升级石一阶 62 27839，装备_升级石二阶 13 29138，装备_升级石三阶 0 25318，装备_升级石四阶 30 37893，兽魂_月狐 53 37708，兽魂_麒麟 51 37707，兽魂_獬豸 45 37710，兽魂_狴犴 41 37706，兽魂_裂海玄龙鲸 4 37709，兽魂_珊瑚独角兽 2 38885，兽魂_冰甲角魔龙 3 40515，兽魂_赤炎金猊兽 2 38886，兽魂_梼杌 7 38888，兽魂_饕餮 4 40516，兽魂_穷奇 4 37711，兽魂_混沌 4 38887，兽魂_青龙 8 29229，兽魂_白虎 36 26758，兽魂_玄武 50 25565，兽魂_朱雀 32 26794，通用兽魂一星 60 15693，通用兽魂二星 27 11040，通用兽魂三星 15 6937，通用兽魂四星 2 39733，宝箱_+2 242 1957，宝箱_+3 8 1956，宝箱_+4 1011 40499，碎片_宝箱+3 3 2813，碎片_宝箱+4 12 2814，碎片_宝箱+5 4 7476，潜能_血牛 144 22870，潜能_血牛+4 2461 1220，潜能_莽夫+4 545 15665，潜能_金刚+4 3 1222，潜能_神行+4 2056 1223，潜能_血牛+5 1800 28866，潜能_神行+5 190 26305，潜能_血牛+6 246 34741，※盟宠经验水_少许 6 42698，※盟宠经验水_大量 15 42697，
                    String[] items = split[1].split("，");
            ...
            case "赞获":
                if (split.length >= 2) {
                    //赞助2014获取〓hy815〓123	183.60.204.16	183.60.204.16
                ...
                break;
            case "赞助点兑换元宝成功":
                //赞助点兑换元宝〓hy815〓123〓100	183.60.204.16	183.60.204.16
            ...
            case "赞助查询日消费累计":
                if (split.length >= 2) {
                    //赞助查询每日消费累计〓hy815	183.60.204.16	183.60.204.16
                    //赞助查询日消费累计〓hy815〓100〓0
                }
                break;
            case "赞助本日消费累计领奖完成":
                if (split.length >= 3) {
                    //赞助点每日消费累计领奖〓hy815	183.60.204.16	183.60.204.16
                    //赞助本日消费累计领奖完成〓100〓1
    ...
    private void onLingquDaylyRewardRsp(String[] split) {
        if (split.length >= 2) {
            //盟军个人每日活力任务累计额外领取〓hy814〓123	183.60.204.16	183.60.204.16
            //盟军每日任务累计次数奖励完成〓3
            //盟军个人每日活力任务累计额外领取〓hy814〓123	183.60.204.16	183.60.204.16
            //盟军每日任务累计次数奖励完成〓4
    ...
    private boolean onReadDaylyTaskRsp(String[] split, boolean needRepeat) {
        int gap;
        if (split.length >= 4) {
            //盟军个人每日活力任务查询〓hy814〓123	183.60.204.16	183.60.204.16
...
//                                Log.e(TAG, "update: 要进行赏金猎人副本，停止了，还差" + gap + " 次");
    ...
    private void readPetPiceShop() {
        postMsg(R.string.msg_read_pet_pice_shop);
        setCmd(R.string.jingsuishangcheng_read);
    }

    private void resetPetPiceShop() {
        postMsg(R.string.msg_reset_pet_pice_shop);
        setCmd(R.string.jingsuishangcheng_reset);
    }

    private void buyPetPice(int i, String s) {
        postMsg(R.string.msg_buy_pet_pice_shop,s);
        setCmd(R.string.jingsuishangcheng_buy,i);
    }
