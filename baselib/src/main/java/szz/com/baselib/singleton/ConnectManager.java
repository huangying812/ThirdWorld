...
//                                  购买状态    | -------------元神+1到+9----------------|  宝箱  火淬 赞助点  固定     元宝     购买物品
    ...
    private boolean processResponse(String res, String[] split, String cmd) {
        ...
        switch (split[0]) {
            ...
            case "盟军物品使用提取活力":
                if (split.length >= 2) {
                    //帮派个人使用物品〓hy814〓123〓42941〓89	183.60.204.64	183.60.204.64
            ...
            case "盟军物品使用通用":
                if (split.length >= 2) {
                    //帮派个人使用物品〓hy812〓123〓43035〓10	183.60.204.64	183.60.204.64
            ...
            case "盟军物品使用盟宠经验水":
                if (split.length >= 2) {
                    ...
                    //帮派个人使用物品〓hy814〓123〓42697〓15	183.60.204.64	183.60.204.64
